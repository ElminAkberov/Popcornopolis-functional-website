...
function DoubleDrizzle() {
    ...
    return (
        <div className='overflow-hidden'>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style={{ fill: "#CE242F" }} className='max-lg:hidden  absolute max-[1300px]:left-[-120px] left-0' width="620" height="220" viewBox="0 0 620 220">
                <defs>
            ...
            <div style={{ borderRadius: "0 0 0 100px " }} className=" bg-[rgb(226,39,51)] max-lg:relative max-lg:overflow-hidden  lg:flex pt-32 mx-auto max-lg:h-auto h-[80vh]">

                <p className='flex lg:hidden items-center gap-x-2 text-white text-[15px] font-sofia font-bold relative z-10 px-[30px]'><FaArrowLeftLong /> <NavLink to={"/shop/"}>Back to the products</NavLink></p>
                <div className='lg:block hidden'>
                    <p className='flex items-center gap-x-2 text-white relative z-10 font-sofia font-bold text-[15px] px-[30px]'><FaArrowLeftLong /> <NavLink to={"/shop/"}>Back to the products</NavLink></p>
                    <div className="w-[50%] rounded-tr-[200px] h-[700px] mt-10 px-[30px] bg-white absolute">
                        <div className="w-[70%] ">
                            <p className='mt-5 '><NavLink className="underline text-[17px] font-sofia font-bold">No Reviews Yet</NavLink></p>
                            <h1 className='text-[#E22733] mb-0 text-[44px] max-[1200px]:text-[32px] leading-[1.2]'>Double Drizzle Popcorn Bag<span className='text-[#613223]'>.</span></h1>
                            <div className='mt-2 w-7 h-1 my-5 bg-[#E22733]'></div>
                            <p className="text-[19px] text-[#E22733] font-sofia font-bold">Pack of 6 </p>
                            <div className="text-[#613223]">
                                <p className='text-[19px] pt-1 max-[1200px]:text-[17px] font-sofia'>One fantastic snack with double the drizzle, double the flavors, and double the enjoyment. Featuring two kinds of gourmet popcorn, Caramel and Kettle, and two chocolatey toppings, white and dark, you won't have to think twice about snacking on this wildly delicious everyday treat.</p>
                                <p className='my-7 font-sofia'><strong>Flavors: </strong>Double Drizzle</p>
                                <p className='mt-5 font-sofia font-bold'><NavLink to={"https://www.popcornopolis.com/wp-content/uploads/MicrosoftTeams-image-13.png"} className="underline text-[17px]">Nutrition Facts & Ingredients</NavLink></p>
                            </div>
                        </div>
                    </div>
                    <div className=' overflow-hidden  bg-[#E22733]  h-[90vh] mb-[200px] rounded-bl-[200px] absolute right-0 w-[50%]'>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style={{ fill: "#CE242F" }} className={`absolute bottom-[-300px] `} width="1178.155" height="1024" viewBox="0 0 1178.155 1024">
                            <defs>
                        ...
                        <div className="w-[60%] flex flex-col float-right px-[30px] text-white relative top-[10rem]">
                            ...
                            <div className=" font-sofia font-bold">
                                <label className="container2 text-[19px]">One-time purchase
                                    <input onChange={(item) => { changePrice(item.target.parentNode.innerText) }} type="radio" name='check' checked={price == "23.99" ? true : ""} />
                                    <span className="checkmark"></span>
                                </label>

                                <label className="container2 text-[19px]">Subscribe & Save 10%
                                    <input onChange={(item) => { changePrice(item.target.parentNode.innerText) }} type="radio" name='check' checked={price == "21.59" ? true : ""} />
                                    <span className="checkmark "></span>
                                </label>
                            </div>
                            <div className='flex'>
                                <div className="min-[1200px]:py-4 py-2 my-5 relative px-2 bg-white w-[100%] max-[1200px]:w-[40%] max-[1200px]:px-5 rounded-full flex justify-between">
                                    <div className="w-max">
                                        <button className='bg-[#613223] px-2  rounded-full'>-</button>
                                        <input className='placeholder-black text-black text-center placeholder-shown:text-center w-[30%]' placeholder='0' type="text" />
                                        <button className='bg-[#613223] px-2  rounded-full'>+</button>
                                    </div>
                            ...
                            <div className="relative bottom-0 right-0 hidden max-[1200px]:block">
                                <button className='flex items-center gap-4 rounded-full text-[20px] text-[#613223] bg-[#F2F4F9] py-[13px] px-12 font-sofia font-bold  duration-300'>Out of Stock <FaArrowRightLong /></button>
                            </div>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" className='lg:hidden  top-[-500px] absolute  max-w-[full]' style={{ fill: "#CE242F" }} width="1178.155" height="1024" viewBox="0 0 1178.155 1024">
                    <defs>
                        <clipPath id="lclip-path">
                ...
                <img className='relative lg:w-[28%] max-lg:max-h-[322px] max-w-full lg:right-24 lg:top-20  flex m-auto' src="/assets/img/Shop popcorn/DoubleDrizzle.webp" alt="" />
            </div>
            <div className=''>
                <div className="px-[30px] hidden max-lg:block">
                    <p className='mt-5 '><NavLink className="underline text-[17px] font-sofia font-bold">No Reviews Yet</NavLink></p>
                    <h1 className='text-[#E22733] mb-0 text-[35px] max-[450px]:text-[25px] leading-[1.2]'>Double Drizzle Popcorn Bag<span className='text-[#613223]'>.</span></h1>
                    <p className="text-[19px] text-[#613223] font-sofia font-bold">Pack of 12</p>
                    <div className='mt-2 w-7 h-1 my-5 bg-[#E22733]'></div>
                    <div className="text-[#613223]">
                        <div className="">
                            <p className='text-[35px]'>${price}</p>
                            <div className="check2 font-sofia font-bold">
                                <label className="container2 text-[17px]">One-time purchase
                                    <input onChange={(item) => { changePrice(item.target.parentNode.innerText) }} type="radio" name="purchaseOption" checked={price == "23.99" ? true : ""} />
                                    <span className="checkmark2"></span>
                                </label>

                                <label className="container2 text-[17px]">Subscribe & Save 10%
                                    <input onChange={(item) => { changePrice(item.target.parentNode.innerText) }} type="radio" name="purchaseOption" checked={price == "21.59" ? true : ""} />
                                    <span className="checkmark2"></span>
                                </label>
                            </div>
                            ...
                            <div className="flex  gap-x-20">
                                <div className="">
                                    <input className='max-w-[70px] absolute border-[#d1c4c0]  border-2 text-center placeholder-[#613233] py-3 rounded-full text-[#613223]  placeholder-shown:text-center' placeholder="1" type="text" />
                                </div>
                                <div className="">
                                    <button className='flex max-w-[270px] items-center gap-4 rounded-full text-[17px] max-[450px]:text-[15px] text-[#fff] bg-[#E9646B] py-3 px-16 max-[450px]:px-10 font-sofia font-bold  duration-300'>Out of Stock <FaArrowRightLong /></button>
                                </div>
                            </div>
                        </div>
                        <p className='text-[19px] max-lg:text-[14px] pt-1 font-sofia '>We’re adding some heat to the season. Introducing Popcornopolis® Takis Fuego® Popcorn, an intense flavor combination that brings spicy and tart together to wake-up the taste buds. Add the perfect crunch of our premium popcorn and you won’t be able to extinguish the heat between bites.</p>
                        <p className='my-7 max-lg:text-[14px] font-sofia ' ><strong>Flavors: </strong>Hot Chili Pepper & Lime</p>
                        <p className='mt-5 '><NavLink className="underline text-[17px] max-lg:text-[14px]">Nutrition Facts & Ingredients</NavLink></p>
                        ...
                        <div className="mt-10 flex gap-2">
                            ...
                            <div className="">
                                ...
                                <p className='text-[30px] max-[450px]:text-[25px] text-[#E22733] my-3 leading-none font-sofia font-bold'>Create Your Own<strong className='text-[#613223]'>.</strong></p>
                                <p className='lg:text-[22px] text-[20px] leading-none block max-[400px]:hidden'><NavLink className="flex items-center gap-x-3 underline" to={"/create-your-own"}>Create Your Own <span className='inline-flex items-center'><FaAngleRight size={20} className='p-1 rounded-full text-white bg-[#E40C13]' /></span></NavLink></p>
                            </div>
                        </div>
                ...
                <div className="  mt-[450px] max-lg:mt-20">
                    <div className="px-[30px]  max-w-[1240px] mx-auto ">
                        <div className='lg:flex gap-x-5 mb-[180px]'>
                            <img className='rounded-bl-[150px] lg:rounded-tr-[150px] w-full' src="/assets/img/Shop popcorn/Takis1.jpg" alt="" />
                            <div className="">
                                <p className='text-[60px] max-[1200px]:text-[50px] max-lg:text-[33px] max-[450px]:text-[25px] text-[#E22733] my-3 leading-none '>About This Flavor<strong className='text-[#613223]'>.</strong></p>
                                <div className='mt-2 w-7 h-1 my-5 bg-[#E22733]'></div>
                                <p className='text-[#613223] lg:text-[19px] font-sofia '>Some like it hot. That’s why the Popcornopolis Takis Fuego edition was forged in flames. And out of the fire, rises not just the intense flavor combination of hot chili pepper and lime, but the passion to be bold. Do you have what it takes to face the flame? Get ready for a journey that starts with heat, ends with fun, and is designed to relive over and over.</p>
                            </div>
                        </div>
                        <div className='lg:flex gap-x-5 '>
                            <img className='rounded-bl-[100px] order-1 lg:rounded-tr-[150px] w-full' src="/assets/img/Shop popcorn/Takis2.jpg" alt="" />
                            <div className="">
                                <p className='text-[60px] max-[1200px]:text-[50px] max-lg:text-[33px] max-[450px]:text-[25px] text-[#E22733] my-3 leading-none '>Ready for a temperature adventure<strong className='text-[#613223]'>.</strong></p>
                                <div className='mt-2 w-7 h-1 my-5 bg-[#E22733]'></div>
                                <p className='text-[#613223] lg:text-[19px] font-sofia '>Do not adjust your thermostat. Popcornopolis Takis Fuego tall cones are a perfect way to warm up any holiday event. Excellent for school and office parties, bringing along on the holiday road trip, or livening up this year’s stockings. Fun design. Bold flavor. Stop, drop, and roll. This is not a drill.</p>
                            </div>
                        </div>
                        <div className="mt-20 text-center">
                            ...
                            <button onClick={() => { setOpenReview(!review) }} className='flex mx-auto mt-10  items-center gap-4 rounded-full text-[#fff] font-sofia font-bold bg-[#E22733] py-3 px-8   duration-300'>Write a review <FaArrowRightLong /></button>
                        </div>
                    </div>
                    {review && (
                    ...
                    <div className=" justify-center flex ">
                        <form onSubmit={(e) => sendReview(e)} style={{ zIndex: 90 }} className={`fixed ${!review ? 'hidden' : ""} max-w-[988px] p-[20px] pb-[50px] px-[50px] w-full max-md:overflow-y-scroll   max-[350px]:h-[90vh] max-[350px]:overflow-y-scroll bg-white top-[13%] `}>
                            <div className="flex items-center justify-between">
                                <h3 className='text-[35px] max-[1200px]:text-[29px] max-md:text-[33px] text-[#E22733]'>Write a review<span className='text-[#613223]'>.</span></h3>
                            ...
                            <div className='flex'>
                                ...
                                <div className="">
                                    <img className='absolute max-w-[300px] top-[-50px]  right-[100px] max-md:hidden' src="/assets/img/Shop popcorn/DoubleDrizzle.webp" alt="" />
                                </div>
                            </div>
                            <label htmlFor="">
                            ...
                            <div className="bg-[#84C4EC]  px-[40px] rounded-tr-[100px] rounded-bl-[50px] py-[70px] lg:max-w-[460px] min-h-[600px] max-[1200px]:min-h-[500px] ">
                                <div>
                                    ...
                                    <div className="text-[20px] text-white px-[35px]">
                                        ...
                                        <button className="flex mt-10 items-center gap-4 rounded-full font-sofia font-bold text-[#fff] max-lg:text-[14px] bg-[#E22733] py-3 px-10 duration-300">Learn more <FaArrowRightLong /></button>
                                    </div>
                                </div>
                            </div>
                        </div>
